...
while true; do
    ...
    mqtt_publish "SunSynk" "battery_voltage" "${BATTERY_VOLTAGE}" "V" "voltage" "measurement"
    mqtt_publish "SunSynk" "battery_current" "${BATTERY_CURRENT}" "A" "current" "measurement"
    mqtt_publish "SunSynk" "battery_soc" "${BATTERY_SOC}" "%" "battery" "measurement"
    mqtt_publish "SunSynk" "battery_power" "${BATTERY_POWER}" "W" "power" "measurement"
    mqtt_publish "SunSynk" "battery_temperature" "${BATTERY_TEMPERATURE}" "°C" "temperature" "measurement"
    mqtt_publish "SunSynk" "today_battery_charge" "${TODAY_BATTERY_CHARGE}" "kWh" "energy" "total_increasing"
    mqtt_publish "SunSynk" "today_battery_discharge" "${TODAY_BATTERY_DISCHARGE}" "kWh" "energy" "total_increasing"

    mqtt_publish "SunSynk" "inverter_voltage" "${INVERTER_VOLTAGE}" "V" "voltage" "measurement"
    mqtt_publish "SunSynk" "inverter_current" "${INVERTER_CURRENT}" "A" "current" "measurement"
    mqtt_publish "SunSynk" "inverter_power" "${INVERTER_POWER}" "W" "power" "measurement"
    mqtt_publish "SunSynk" "inverter_frequency" "${INVERTER_FREQUENCY}" "Hz" "frequency" "measurement"

    mqtt_publish "SunSynk" "grid_voltage" "${GRID_VOLTAGE}" "V" "voltage" "measurement"
    mqtt_publish "SunSynk" "grid_current" "${GRID_CURRENT}" "A" "current" "measurement"
    mqtt_publish "SunSynk" "grid_power" "${GRID_POWER}" "W" "power" "measurement"
    mqtt_publish "SunSynk" "grid_frequency" "${GRID_FREQUENCY}" "Hz" "frequency" "measurement"
    mqtt_publish "SunSynk" "today_grid_import" "${TODAY_GRID_IMPORT}" "kWh" "energy" "total_increasing"
    mqtt_publish "SunSynk" "today_grid_export" "${TODAY_GRID_EXPORT}" "kWh" "energy" "total_increasing"
    mqtt_publish_text "SunSynk" "grid_status" "${GRID_STATUS}"

    mqtt_publish "SunSynk" "load_voltage" "${LOAD_VOLTAGE}" "V" "voltage" "measurement"
    mqtt_publish "SunSynk" "load_current" "${LOAD_CURRENT}" "A" "current" "measurement"
    mqtt_publish "SunSynk" "load_power" "${LOAD_POWER}" "W" "power" "measurement"
    mqtt_publish "SunSynk" "load_frequency" "${LOAD_FREQUENCY}" "Hz" "frequency" "measurement"
    mqtt_publish "SunSynk" "today_load_usage" "${TODAY_LOAD_USAGE}" "kWh" "energy" "total_increasing"

    mqtt_publish "SunSynk" "pv_voltage" "${PV_VOLTAGE}" "V" "voltage" "measurement"
    mqtt_publish "SunSynk" "pv_current" "${PV_CURRENT}" "A" "current" "measurement"
    mqtt_publish "SunSynk" "pv_power" "${PV_POWER}" "W" "power" "measurement"
    mqtt_publish "SunSynk" "today_pv_generation" "${TODAY_PV_GENERATION}" "kWh" "energy" "total_increasing"

    mqtt_publish_text "SunSynk" "program_time1" "${PROGRAM_TIME1}"
    mqtt_publish_text "SunSynk" "program_time2" "${PROGRAM_TIME2}"
    mqtt_publish_text "SunSynk" "program_time3" "${PROGRAM_TIME3}"
    mqtt_publish_text "SunSynk" "program_time4" "${PROGRAM_TIME4}"
    mqtt_publish_text "SunSynk" "program_time5" "${PROGRAM_TIME5}"
    mqtt_publish_text "SunSynk" "program_time6" "${PROGRAM_TIME6}"

    mqtt_publish_text "SunSynk" "program_charge1" "${PROGRAM_CHARGE1}"
    mqtt_publish_text "SunSynk" "program_charge2" "${PROGRAM_CHARGE2}"
    mqtt_publish_text "SunSynk" "program_charge3" "${PROGRAM_CHARGE3}"
    mqtt_publish_text "SunSynk" "program_charge4" "${PROGRAM_CHARGE4}"
    mqtt_publish_text "SunSynk" "program_charge5" "${PROGRAM_CHARGE5}"
    mqtt_publish_text "SunSynk" "program_charge6" "${PROGRAM_CHARGE6}"

    mqtt_publish "SunSynk" "program_capacity1" "${PROGRAM_CAPACITY1}" "%" "battery" "measurement"
    mqtt_publish "SunSynk" "program_capacity2" "${PROGRAM_CAPACITY2}" "%" "battery" "measurement"
    mqtt_publish "SunSynk" "program_capacity3" "${PROGRAM_CAPACITY3}" "%" "battery" "measurement"
    mqtt_publish "SunSynk" "program_capacity4" "${PROGRAM_CAPACITY4}" "%" "battery" "measurement"
    mqtt_publish "SunSynk" "program_capacity5" "${PROGRAM_CAPACITY5}" "%" "battery" "measurement"
    mqtt_publish "SunSynk" "program_capacity6" "${PROGRAM_CAPACITY6}" "%" "battery" "measurement"
